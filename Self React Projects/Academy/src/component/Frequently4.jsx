...
import faq from '../assets/Images/faq4.png'
...
const Frequently2 = () => {
    ...
    return (
        <div>
            ...
            <div className='container d-flex flex-column-reverse flex-lg-row  justify-content-evenly align-items-center'>
            ...
            <div className="freqcontainer col-lg-6 col-10">
                ...
                <div className='freqbutton'>
                    <button className='' style={{width:"10vmax"}}>See More</button>
                </div>
            </div>
            <div className='col-lg-6 col-10'>
                <img src={faq} alt="" className='col-10' />
            </div>
            </div>
        </div>
    )
